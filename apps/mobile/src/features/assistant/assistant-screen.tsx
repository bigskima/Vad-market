      ...
      <View style={{ gap: theme.spacing.md }}>
        {activeThread ? (
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: theme.spacing.sm }}>
            ...
            <VadButton label="Archive" variant="ghost" size="small" fullWidth={false} onPress={() => void archiveCurrent()} />
          </View>
        ) : null}
  ...
  return (
    <View style={{ alignItems: user ? 'flex-end' : 'flex-start' }}>
      ...
      >
        ...
        <MarketRelativeTime value={message.createdAt} prefix={user ? 'Sent' : 'Answered'} />
      </View>
    </View>
  );
}
