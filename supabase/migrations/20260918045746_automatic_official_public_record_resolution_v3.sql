...
select 'VAD Automatic Official Public Record Policy',capability_id,2,'["US_SENATE"]'::jsonb,'{"environment":"PRODUCTION","tie_behavior":"NO_RESOLUTION","finalization_mode":"AUTO_AFTER_DISPUTE_WINDOW","distinct_providers":false,"min_agreeing_providers":1}'::jsonb,close_rule,postponement_rule,cancellation_rule,void_rule,60,'ACTIVE',statement_timestamp(),null,approved_by
...
where e.id=b.event_id and e.public_id='e63d82f5-3026-428b-a05e-1166a61f50b2' and p.capability_id=1 and p.version=2;