alter function public.internal_apply_market_admission_result(uuid,uuid,text,bigint,bigint,jsonb,text) rename to internal_apply_market_admission_result_unchecked;

drop function if exists public.internal_apply_market_admission_result_v2(uuid,uuid,text,bigint,bigint,jsonb,text);

create function public.internal_apply_market_admission_result(
...
revoke all on function public.internal_apply_market_admission_result_unchecked(uuid,uuid,text,bigint,bigint,jsonb,text) from public,anon,authenticated,service_role;
